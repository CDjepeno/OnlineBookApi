...
export enum ErrorMessageEnum {
  ...
  USER_CREATE_ERROR = "Une erreur est survenue lors de la création d'utilisateur",
  USER_LOGIN_ERROR = "Une erreur est survenue lors de la connexion d'utilisateur",
